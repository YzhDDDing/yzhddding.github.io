...
Currently, my research focuses on hardware security, particularly processor fuzzing and vulnerability detection, and model-driven development to enhance the efficiency and reliability of critical systems, including aerospace and automotive applications. In addition, I am also interested in EDA and AI for Software Engineering (AI4SE).
